...
class ThumbRater(Fixture):
    ...
    def get_rating(self, id=None):
        ...
        return dict(rating = 0)# set default value of rating as 0 for false and 1 for true

    def set_rating(self, id=None):
        """Sets the state of rating."""
        # This is a test implementation that should be over-ridden.
        print("Value of rating set to:", id, int(request.params.num_rating))
        return "ok"
